...
class IHD_VIP_Audit_Logger {
     ...
     * @param bool   $intentional     Whether the cancellation was intentional by the user.
     * @param string $reason          The selected reason (radio option).
     * @param string $text            Additional feedback text.
